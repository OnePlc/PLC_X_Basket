...
use OnePlace\Basket\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/basket/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('basket-api');
    }
}
