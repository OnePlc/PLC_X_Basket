<?php
/**
 * BasketControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Basket Module
 *
 * @category Test
 * @package Basket
...
namespace OnePlaceTest\Basket\Controller;

use OnePlace\Basket\Controller\BasketController;
...
class BasketControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/basket', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('basket');
        $this->assertControllerName(BasketController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BasketController');
        $this->assertMatchedRouteName('basket');
    }
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/basket/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('basket');
        $this->assertControllerName(BasketController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BasketController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/basket/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('basket');
        $this->assertControllerName(BasketController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BasketController');
